...
public class BookingController {
    ...
    @PostMapping
    public ResponseEntity<?> createBooking(@RequestHeader(value = "X-User-Role", required = false) String role,
    ...
    public ResponseEntity<?> cancelBooking(@RequestHeader(value = "X-User-Role", required = false) String role,
                                           @PathVariable Long id) {
        if (!AdminAccess.isAdmin(role)) {
            return AdminAccess.forbidden();
        }
    ...
    public ResponseEntity<?> checkoutBooking(@RequestHeader(value = "X-User-Role", required = false) String role,
                                             @PathVariable Long id) {
        if (!AdminAccess.isAdmin(role)) {
            return AdminAccess.forbidden();
        }
